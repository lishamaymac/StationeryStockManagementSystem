...
{
	$p=sha1($pass);
	$sql=mysqli_query($set,"SELECT * FROM staff WHERE sid='$sid' AND password='$p'");
...
<tr><td class="labels">Staff ID : </td><td><input type="text" name="sid" class="fields" size="25" placeholder="Enter Staff ID" required="required" /></td></tr>
